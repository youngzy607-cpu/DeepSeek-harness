...
async function saveInstructions(content: string): Promise<void> {
...
export type CustomInstructionsTabProps = PropsRuntime<'settings.plugins.tab'>

export function CustomInstructionsTab({ t }: CustomInstructionsTabProps): JSX.Element {
